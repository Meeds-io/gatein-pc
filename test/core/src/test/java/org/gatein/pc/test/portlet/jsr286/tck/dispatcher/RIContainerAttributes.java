...
public class RIContainerAttributes extends DispatchedContainerAttributes
{
   ...
   private static Map<String, String> buildAttributes(ServletContext ctx)
   {
      ...
      map.put("jakarta.servlet.include.request_uri", ctx.getContextPath() + "/universalServletA/pathinfo");
      ...
      map.put("jakarta.servlet.include.path_info", "/pathinfo");
      map.put("jakarta.servlet.include.query_string", "foo=bar");
